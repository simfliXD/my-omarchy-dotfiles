#
# Omarchy environment (OMARCHY_PATH + PATH), needed e
[[ -r /usr/share/omarchy/default/bash/env-bootstrap ]

# If not running interactively, don't do anything els
[[ $- != *i* ]] && return

# All the default Omarchy aliases and functions
# (don't mess with these directly, just overwrite the
source "$OMARCHY_PATH/default/bash/rc"

# Add your own exports, aliases, and functions here.
#
# Make an alias for invoking commands you use constan
# alias p='python'
